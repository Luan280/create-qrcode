...
app.grid_columnconfigure((0, 5), weight=5)
...
size_qrcode.grid(row=2, column=0, padx=10, pady=10)

size_box = ctk.CTkComboBox(app, width=size_width, height=size_height)
size_box.grid(row=3, column=0, padx=10, pady=10)

size_border = ctk.CTkComboBox(app, width=size_width, height=size_height)
size_border.grid(row=4, column=0, padx=10, pady=10)
...
test_button.grid(row=5, column=1, padx=10, pady=10)
